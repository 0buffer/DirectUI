      ...
      "<HorizontalLayout>"
        "<VerticalLayout width=\"150\" >"
          ...
          "<NavigatorPanel>"
            ...
            "<NavigatorButton name=\"page_configure\" text=\"<i 4> Opssning\" />"
        ...
        "<VerticalLayout>"
          ...
          "<WindowCanvas watermark=\"StartWatermark\" >"
            "<VerticalLayout>"
              "<TextPanel text=\"<f 8>Vsg startomroe?</h>\" />"
              "<FadedLine />"
              "<TileLayout scrollbar=\"true\" >"
                "<TextPanel name=\"link_registers\" text=\"<i 7 50><a><f 6>&Registre</f></a>\n<h>\n<c #444540>Vsg denne menu for at rette i diverse registre i systemet.\n\nDu kan rette i kunde, vogn og chauffør-reigsteret.\" shortcut=\"R\" />"
                "<TextPanel name=\"link_systems\" text=\"<i 9 50><a><f 6>&Systemer</f></a>\n<h>\n<c #444540>Gennem denne menu kan du opsste diverse ting.\" shortcut=\"S\" />"
                "<TextPanel name=\"link_configure\" text=\"<i 6 50><a><f 6>Opssning</f></a>\n<h>\n<c #444540>Opssning giver adgang til konfiguration af de mange ksels-systemer og regler.\" />"
      ...
      "<HorizontalLayout>"
        "<VerticalLayout width=\"150\" >"
          ...
          "<NavigatorPanel>"
            ...
            "<NavigatorButton name=\"page_registers\" text=\"<i 4> Registre\" tooltip=\"Vis forskellige registre\" />"
            "<NavigatorButton name=\"page_systems\" text=\"<i 4> Systemer\" />"
            "<NavigatorButton name=\"page_configure\" text=\"<i 4> Opssning\" selected=\"true\" />"
            "<NavigatorButton name=\"page_reports\" text=\"<i 4> Rapporter\" />"
          "</NavigatorPanel>"
        "</VerticalLayout>"
        "<VerticalLayout>"
          "<Toolbar>"
            "<LabelPanel align=\"right\" text=\"<f 6><c #fffe28>System Opssning</c></f>\" />"
          "</Toolbar>"
          "<ToolbarTitlePanel name=\"titlepanel\" text=\"<f 7>System Opssning</f>\" />"
          "<TitleShadow />"
          "<WindowCanvas>"
            "<VerticalLayout>"
              ...
              "<HorizontalLayout>"
                ...
                "<VerticalLayout>"
                  "<TextPanel text=\"<f 6><c #2c4378>Opssningsliste</c></f>\" />"
                  "<SeparatorLine />"
                  ...
                  "<List header=\"hidden\" >"
                     ...
                     "<ListLabelElement text=\"<i 4> Chauffer register\" />"
        ...
        "<VerticalLayout>"
          ...
          "<WindowCanvas>"
            "<TileLayout>"
               ...
               "<TextPanel text=\"<i 2 50><a><f 6>Chauffer Rapporter</f></a>\n<h>\n<c #444540>Rapporter for chauffer registeret.\" />"
